...
**CI screenshot:** _add a screenshot of the green build here before submitting._

## Video Walkthrough

**YouTube (unlisted):** _add your video link here._
...
AI assistance was used to help structure and format the Part 1 planning documents
(ERD layout, endpoint-plan formatting, and SQL scaffolding). All design decisions
were reviewed, understood, and finalised by the author.
